var sectionComedia = document.getElementById('comedia');
var subtituloComedia = document.getElementById('subtitulo');
...
request.onload = function() {
  ...
  showSubtituloComedia(peliculas);
  showPeliculasComedia(peliculas);

}


function showSubtituloComedia(){
  
  var subtitulo = document.createElement("h1");
  subtitulo.className = "subtitulo-comedia";
  subtitulo.textContent = "Comedia";
  subtituloComedia.appendChild(subtitulo);

}


function showPeliculasComedia(jsonObj) {
    var peliculas = jsonObj['peliculas'];
       
     
      for (var i = 0; i < peliculas.length; i++) {

        if(peliculas[i].genero === "Comedia"){
          ...
          sectionComedia.appendChild(card);
