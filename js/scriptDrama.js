var sectionDrama = document.getElementById('drama');
var subtituloDrama = document.getElementById('subtitulo');
...
request.onload = function() {
  ...
  showSubtituloDrama(peliculas);
  showPeliculasDrama(peliculas);

}


function showSubtituloDrama(){
  
  var subtitulo = document.createElement("h1");
  subtitulo.className = "subtitulo-drama";
  subtitulo.textContent = "Drama";
  subtituloDrama.appendChild(subtitulo);

}


function showPeliculasDrama(jsonObj) {
