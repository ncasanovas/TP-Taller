var sectionThriller = document.getElementById('thriller');
var subtituloThriller = document.getElementById('subtitulo');
...
request.onload = function() {
  ...
  showSubtituloThriller(peliculas);
  showPeliculasThriller(peliculas);

}


function showSubtituloThriller(){
  
  var subtitulo = document.createElement("h1");
  subtitulo.className = "subtitulo-thriller";
  subtitulo.textContent = "Thriller";
  subtituloThriller.appendChild(subtitulo);

}


function showPeliculasThriller(jsonObj) {
    var peliculas = jsonObj['peliculas'];
       
     
      for (var i = 0; i < peliculas.length; i++) {

        if(peliculas[i].genero === "Thriller"){
          ...
          sectionThriller.appendChild(card);
